...
public class ShowComplaintsActivity extends AppCompatActivity {
    ...
    private void settingAdapter() {
        FirebaseRecyclerOptions<ComplaintsModel> options = new FirebaseRecyclerOptions.Builder<ComplaintsModel>().setQuery(complaintsRef, ComplaintsModel.class).build();
